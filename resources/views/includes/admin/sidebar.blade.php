        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item has-treeview {{request()->is('product', 'supplier', 'stok', 'stok/transaksi_riwayat_in') ? 'menu-open': ''}}">
                    <a href="#" class="nav-link {{request()->is('product', 'supplier','stok', 'stok/transaksi_riwayat_in') ? 'active': ''}}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="/stok/transaksi_riwayat_in" class="nav-link {{request()->is('stok/transaksi_riwayat_in') ? 'active': ''}}">
                                <i class="far fa-circle nav-icon {{request()->is('stok/transaksi_riwayat_in') ? 'far fa-dot-circle': ''}}"></i>
                                <p>
                                    Transaction History
                                </p>
                            </a>
